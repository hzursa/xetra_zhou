"""Intergration Test Xetra ETL Methods"""
import os
import unittest
...
class IntTestXetraETLMethods(unittest.TestCase):
    """
    Intergration Testing the XetraETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-zhou'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-zhou'
        ...
        # Here should be some error from the material, the change_prev_closing_% are calculated using opening data
